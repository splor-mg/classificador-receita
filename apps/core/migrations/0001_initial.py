# Generated by Django 6.0.1 on 2026-05-20 12:48

import apps.core.models_alias_lexico
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "termo",
                    models.CharField(
                        help_text="Forma completa a partir da qual se deriva a abreviação. Único na tabela em sentido semântico (case-insensitive; ativa ou inativa em transaction time).",
                        max_length=512,
                        verbose_name="Termo",
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        default=apps.core.models_alias_lexico.lista_abreviacoes_registro_inicio_novo,
                ...
                (
                    "data_registro_fim",
                    models.DateTimeField(
                        default=apps.core.models_alias_lexico.lista_abreviacoes_registro_fim_sentinela,
                        help_text="Momento em que a entrada deixa de ser usada. Valor sentinela 31/12/9999 indica registro ativo.",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        django.db.models.functions.text.Lower("termo"),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Referência ao item mãe (nível imediatamente superior na hierarquia). NULL para itens do nível 1.",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
