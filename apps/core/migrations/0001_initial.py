# Generated by Django 6.0.1 on 2026-02-11 20:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Identificador numérico estável da classificação estatística, usado na chave primária lógica (bitemporal). Mesmo valor para todas as linhas que pertencem à mesma entidade (mesmo classificacao_id).",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indica se o item é natureza agregadora (Matriz) ou item folha (Detalhe). Quando true, indica item agregador; quando false, item detalhe em que a execução orçamentária pode ser registrada.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Identificador numérico estável da série de classificações, usado na chave primária lógica (bitemporal). Mesmo valor para todas as linhas que pertencem à mesma entidade (mesmo serie_id).",
                        null=True,
        ...
        migrations.AddConstraint(
            model_name="nivelhierarquico",
            constraint=models.UniqueConstraint(
                fields=("nivel_ref", "data_registro_inicio"), name="unique_nivel_ref_registro"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="itemclassificacao",
            constraint=models.UniqueConstraint(
                fields=("item_ref", "data_registro_inicio"), name="unique_item_ref_registro"
            ),
        ),
        migrations.AddConstraint(
            model_name="itemclassificacao",
            constraint=models.UniqueConstraint(
                fields=("receita_cod", "data_registro_inicio"), name="unique_receita_cod_registro"
            ),
        ),
        migrations.AddIndex(
            model_name="classificacaoreceita",
        ...
        migrations.AddConstraint(
            model_name="versaoclassificacao",
            constraint=models.UniqueConstraint(
                fields=("versao_ref", "data_registro_inicio"), name="unique_versao_ref_registro"
            ),
        ),
        migrations.AddIndex(
