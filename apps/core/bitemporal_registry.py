...
RESOURCES: Dict[str, Dict[str, Any]] = {
    ...
    "item_classificacao": {
        ...
        "fields": [
            ...
            {"name": "matriz", "type": "boolean", "required": False, "default": False, "export_policy": "bool_lower"},
            {"name": "receita_nome", "type": "string", "required": False, "default": ""},
            {"name": "receita_descricao", "type": "string", "required": False, "default": ""},
            {"name": "base_legal_tecnica_id", "type": "fk", "required": False, "fk_resource": "base_legal_tecnica", "fk_semantic_attr": "base_legal_tecnica_id", "fk_current": True, "export_policy": "fk_semantic_or_dash"},
            {"name": "base_legal_tecnica_referencia", "type": "string", "required": False, "default": ""},
            {"name": "destinacao_legal", "type": "string", "required": False, "default": ""},
            {"name": "informacoes_gerenciais", "type": "string", "required": False, "default": ""},
            {"name": "nivel_id", "type": "fk", "required": True, "fk_resource": "nivel_hierarquico", "fk_semantic_attr": "nivel_id", "fk_current": True},
            {"name": "parent_item_id", "type": "fk", "required": False, "fk_resource": "item_classificacao", "fk_semantic_attr": "item_id", "fk_current": True, "export_policy": "fk_semantic_or_dash"},
            {"name": "item_gerado", "type": "boolean", "required": False, "default": False, "export_policy": "bool_lower"},
        ],
        "export_columns": [
            "item_id", "item_ref", "classificacao_id", "receita_cod", "matriz", "receita_nome", "receita_descricao",
            "base_legal_tecnica_id", "base_legal_tecnica_referencia", "destinacao_legal", "informacoes_gerenciais",
